...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-r from-[#FF8008] to-[#FFC837] p-6">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="space-y-3">
          {users.map((user) => (
            ...
            >
              <Link href={`/${user.slug}`} className="block">
                <div className="flex items-center justify-between py-2 px-5">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <h3 className="text-base font-semibold text-card-foreground leading-snug tracking-tight">{user.name}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed font-medium line-clamp-2">{user.description}</p>
                    </div>
                  </div>
